...
insert  into `abonos`(`Id_cliente`,`Id_Prod`,`Fecha_venta`,`Valor_Abono`,`Saldo_Fecha`,`Fecha_Abono`,`recibo`) values (73429935,'0001','2010-10-23',120000,305000,'2010-10-14',NULL),(456459454,'0002','2010-10-23',150000,80000,'2010-10-27','');
...
insert  into `egresos`(`VALOR`,`FECHA`,`ID_GASTO`,`RECIBO`) values (56000,'2010-10-26','123',''),(250000,'2010-10-26','124',''),(55000,'2010-10-29','4578','');
...
insert  into `gastos`(`ID_GASTO`,`TIPO`,`ACTIVO`) values ('123','ENEGIA ELECTRICA','SI'),('124','OTROS GASTOS','SI'),('125','ARRIENDO','SI'),('4578','cervezas','NO');
...
insert  into `inventario`(`ID`,`ARTICULO`,`REFERENCIA`,`PRECIO_COMPRA`,`PRECIO_VENTA`,`CANT_INICIAL`,`COMPRAS`,`VENTAS`,`DEVOLUCIONES`,`CANT_FINAL`,`CANTIDAD_MIN`,`NEGOCIO`) values ('0001','tennis nike','ref 00045',45000,65000,50,5,5,2,52,5,'1'),('0002','zandalias','ref 14578',18500,23000,30,0,10,1,21,3,'1'),('0003','zapatos clasicos','ref 14578',56000,70000,25,0,15,3,13,2.5,'1'),('0004','tennis reebok','ref 45378',45000,55000,0,20,0,0,20,0,'1');
