...
) ENGINE=InnoDB AUTO_INCREMENT=10437 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=11859 DEFAULT CHARSET=latin1;
...
CREATE TABLE `inventario` (
  ...
  `medida` varchar(20) NOT NULL DEFAULT 'UND',
  PRIMARY KEY (`ID_Prod`),
  KEY `Inv` (`IdNegocio`),
