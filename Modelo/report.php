<?php
	...
	class Report extends ConectarPDO{
        ...
        public function journal(){
            $this->sql="SELECT fv.id,SUM(fvd.quantity) AS 'quantity',fvd.`unit_value`,fvd.`subtotal_amount` AS 'subtotal_amount',fv.date_at
            ...
            if($this->modulo=='COMPRA'){
                $this->sql="SELECT fc.id,SUM(fcd.quantity) AS 'quantity',fcd.`unit_value`,fc.`amount` AS 'subtotal_amount',fc.date_at
