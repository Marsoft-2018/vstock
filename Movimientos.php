           ...
           <div class="panel-heading clase3 <?php echo $fondo1; ?>"><h4>Datos relacionados con el movimiento</h4></div>
            <div class="panel-body clase3">
				        ...
				        <?php
                            if($modulo=='VENTA'){
                               echo "<div class='col-md-10'><label>Producto:</label>";
                                ...
                                echo "<input type='text' value='' name='cbo_producto' id='cbo_producto' class='col-md-2 form-control clase3' list='listadeProductos' onchange='buscarProd()' ondblclick='limpiar(this.id)' onkeypress='pasarAcantidad(event)'>";
                ...
                <div class="col-md-2">
                    ...
                    <button type='button' class='btn btn-success btn-agregar-producto' id='<?php echo $modulo ?>' onclick="AgregarAR(this.id)"><i class='fa fa-list-ul'></i> Agregar a la lista</button>
                    </div>
                </div>
		    </div>
           <div class="row">
