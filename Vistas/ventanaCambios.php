        ...
        <div class="col-md-12">                    
          <div class='panel panel-warning'>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <?php                            
                    ...
                    echo "<input type='text' value='' name='cbo_producto' id='productoReemplazo' class='form-control clase3' list='listadeProductos' onchange='cargarDatosArticulo(this.value)' ondblclick='limpiar(this.id)' onkeypress='cargarDatosArticulo(this.value)'>";
            ...
            <div class="panel-footer">
              <input type="hidden" id='productoACambiar' value='<?php echo $productoACambiar ?>'>
...
<script type="text/javascript">
  ...
  function cambiarArticulo(){
    ...
    var productoAcambiar  = document.getElementById('productoACambiar').value;
    var productoReemplazo = document.getElementById('productoReemplazo').value;
    var cantidad = document.getElementById("cantCambio").value;

    //alertify.log("producto a cambiar: "+productoAcambiar+" producto de reemplazo "+productoReemplazo);

    if(productoAcambiar != productoReemplazo ){
        $("#capa").load("Controlador/ctrlDevoluciones.php",
          {
            ...
            productoReemplazo:productoReemplazo,
            cantidad:cantidad
          },function(){
            cerrarCapa();
      ...
      alert("No es necesario realizar este proceso en el sistema cuando es producto a cambiar tiene el mismo código que el producto de reemplazo");
      cerrarCapa();
      cargarDetallesFactura();
    }
  }
