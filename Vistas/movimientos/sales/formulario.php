 ...
 <div id='Contenedor' class='container'>       
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class='form-control' name="" id="" value="<?php echo $objInvoice->maxId(); ?>" readonly>
                    </div>
                    <div class="col-md-3">
                       <label>Fecha:</label>
            ...
            <div class="panel-body">
                ...
                <div class='col-md-2'>
                    <label>Tipo de ventas: </label>
						<select id='tipoVenta' class='col-md-2 form-control' onchange="loadPayForm(this.value)">
                ...
                <div class="col-md-2">	
                    <div class="row">
                        ...
                        <datalist id='listadeProducts'>
                            <option value='231232'> Aire Acondicionado
                            <option value='213233'> Lavadora Hoover
                        </datalist>
                    </div>    
                </div>
        ...
        <div class="container">
            ...
            <div class="card-footer">
                <button class='btn btn-info'  id='Bingresar' onclick='facturar()'>INGRESAR VENTAS</button>
            </div>
        </div>
