            ...
            <div class="col-md-12">                    
                <div class='panel panel-warning'>
                    ...
                    <div class="row">
                        ...
                        <select name="type_return" id="type_return" class="form form-control">
                            <option value="0">Seleccione..</option>
                            <option value="purchase">En Compra</option>
                            <option value="sale">En Venta</option>
                        </select>
                        </div>
                        <div class="col-md-3" name="modulo"  >
                            <label for="invoiceSelect">Buscar Factura</label>
                            <input type='text' value='' name='invoiceSelect' id='invoiceSelect' class='col-md-2 form-control' list='listInvoices' oninput="loadListInvoiceBySelect(this.value,'listInvoices')">
                            <datalist id='listInvoices'>
                                <option value="sale">...</option>
                            </datalist>
                        <!--<input type='text' value='' name='cbo_producto' id="modulofacturasDevolucion" class='form-control clase3' list='listadeProductos' onchange='cargarDatosArticulo(this.value)' ondblclick='limpiar(this.id)'> -->     

                        </div>
                        <div class="col-md-3"><br>
                        <button class="btn btn-primary" onclick='cargarDetallesFactura()'><i class='fa fa-search'> Cargar detalle</i></button>
                        </div>
                    </div>
...
<script>
  ...
  function ventanaDevolucion(producto,cantidad,factura){
    var moduloF = document.getElementById("moduloDevolucion").value;
    //var factura = document.getElementById("modulofacturasDevolucion").value;
  ...
  function ventanaCambiarArticulos(producto){
    var moduloF = document.getElementById("moduloDevolucion").value;
    var factura = document.getElementById("modulofacturasDevolucion").value;
    $("#capa").slideDown("fast");
    $("#capa").load("vistas/ventanaCambios.php",{modulo:moduloF,factura:factura,productoACambiar:producto});
  }
