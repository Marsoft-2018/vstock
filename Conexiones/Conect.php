    ...
    class verificaExistencias extends conectar{//con esta clase se verifica la cantidad de existencias en el inventario
        ...
        public function verificar($id,$modulo){
            ...
            while($cant=mysql_fetch_array($sqlCantidades)){
                ...
                $this->product=$cant[2]." Referencia: ".$cant[3];
            }
            ...
            if($existe==0){
               ...
               echo     "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
               echo         "El product ".$this->product." se encuentra agotado (Existencias = ".$this->cantidadFinal.")";
               echo         "<input type='hidden' id='esNuevo' value='$existe'/>";
               echo "</div>";
            }elseif($this->cantidadFinal==$this->cantidadMin){
               echo "<div class='alert alert-warning alert-dismissable' style='font-size:11px;'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>El product ".$this->product." se encuentra en su cantidad mínima(Existencias = ".$this->cantidadMin.")<input type='hidden' id='esNuevo' value='$existe'/></div>";
            }elseif($this->cantidadFinal==($this->cantidadMin+2)){
               echo "<div class='alert alert-info alert-dismissable' style='font-size:11px;'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>El product ".$this->product." se acerca a su cantidad mínima (Existencias = ".($this->cantidadFinal).")<input type='hidden' id='esNuevo' value='$existe'/></div>"; 
            }elseif($this->cantidadFinal<$this->cantidadMin){
               echo "<div class='alert alert-danger alert-dismissable' style='font-size:11px;'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>El product ".$this->product." se encuentra por debajo de la cantidad mínima (Existencias = ".$this->cantidadFinal.")<input type='hidden' id='esNuevo' value='$existe'/></div>";
            }elseif($this->cantidadFinal==0){
               echo "<div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>El product ".$this->product." se encuentra agotado (Existencias = ".$this->cantidadFinal.")<input type='hidden' id='esNuevo' value='$existe'/></div>";
            }else{               
                echo "<div class='alert alert-success alert-dismissable' style='font-size:11px;'>
                        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                        ".$this->product." (Existencias = ".$this->cantidadFinal.").
                    </div>";
            }            
        }
