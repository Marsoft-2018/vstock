            ...
            while($p=mysql_fetch_array($sql)){
             echo "
                 <tr>
                    ...
                    <td><button type='button' class='btn btn-sm btn-danger eliminar-product fa fa-trash' id='$p[1]' title='Eliminar Product de la lista' onclick='eliminarArticuloTemp(this.id)'></button></td>
                </tr>             
             ";
            }         
        }
        public function agregarProduct($modulo,$id,$cant){
            $precioU;
            $descripcion;
            $subTotal;
